...
export function PreWorkoutScreen() {
  ...
  function renderExerciseItem({ item, index }: { item: StartExerciseDTO; index: number }) {
    return (
      <ExercisePreviewItem 
        item={item} 
        index={index}
  ...
  return (
    <Container>
      ...
      <Content>
        ...
        <View className="relative mb-6">
          ...
          <View className="absolute inset-0 bg-black/30 rounded-xl items-center justify-center">
            <TouchableOpacity className="w-16 h-16 bg-primary rounded-full items-center justify-center">
      ...
      <Footer
        label={currentWorkout?.id === id ? "Continuar Treino" : "Iniciar Treino"}
        paddingHorizontal={0}
