  ...
  return (
    <>
      {open && (
        <View
          className={cn(
            'min-w-[8rem] w-full absolute flex gap-3 overflow-hidden rounded-md border border-border shadow-md mt-3 p-3 top-12 mx-auto justify-center z-50',
            className
          )}
        >
          {children}
...
const DropDownItemSeparator = () => {
  return <View className="h-[1px] bg-gray-400 flex-1" />;
};
const useDropdown = () => {
